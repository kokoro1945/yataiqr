    ...
    "src/main.js"() {
      ...
      async function generate() {
        ...
        if (!boothId) {
          ...
          el.formurl.textContent = "\uFF08\u5C4B\u53F0\u756A\u53F7\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044\uFF09";
          return;
        }
        ...
        try {
          ...
          el.copy.onclick = async () => {
            try {
              ...
              console.error(error);
              alert("\u30B3\u30D4\u30FC\u306B\u5931\u6557\u3057\u307E\u3057\u305F\u3002\u30D5\u30A9\u30FC\u30E0URL\u6B04\u304B\u3089\u624B\u52D5\u3067\u30B3\u30D4\u30FC\u3057\u3066\u304F\u3060\u3055\u3044\u3002");
            }
          };
          el.download.href = dataUrl;
          el.download.download = `Yatai_${boothId}_QR_${size}.png`;
          updateQuery(boothId);
        } catch (error) {
          if (token !== renderToken) return;
          console.error(error);
          showPlaceholder("QR\u751F\u6210\u306B\u5931\u6557\u3057\u307E\u3057\u305F");
          setInteractiveState(false);
        }
      }
      function init() {
        ...
        el.qrsize.addEventListener("change", () => {
          generate().catch((error) => console.error(error));
        });
